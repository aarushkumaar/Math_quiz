...
function text() {
  document.getElementById("ex").innerHTML = "EXPLAINATION:-Rafael Bombelli was an Italian mathematician best known for his work on algebra and the introduction of complex numbers. He played a crucial role in making algebra more structured and accessible.Bombelli was among the first mathematicians to systematically use imaginary numbers.He defined 𝑖 (the square root of -1) and showed how to work with such numbers in equations.His work provided a foundation for later mathematicians like Euler and Gauss."
}
